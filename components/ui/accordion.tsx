...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between gap-3 py-5 text-left text-base font-medium text-charcoal transition hover:text-coral [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
